...
export default {
  ...
  methods: {
    toEdit(id) {
      id ? this.$router.push({ path: `addEnterArena/${id}` }) : this.$router.push({ path: `addEnterArena` })
    },
    toDetail(id) {
      this.$router.push({ name: 'EnterArenaDetail', params: { id } })
    },
    async remove(row) {
