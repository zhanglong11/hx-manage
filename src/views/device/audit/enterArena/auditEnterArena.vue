    ...
    <div class="info">
      <div class="content">
        ...
        <ul>
          ...
          <li>
            <span class="label">计划退场日期</span>
            <span class="val">{{ orderInfo.planLeaveTime }}</span>
          </li>
          <li>
            <span class="label">进场负责人</span>
            <span class="val">{{ orderInfo.principalName }}</span>
          </li>
          <li>
            <span class="label">设备进场所在地</span>
            <span class="val">{{ orderInfo.enterLocation }}</span>
          </li>
          <li>
            <span class="label">设备进场单号</span>
            <span class="val">{{ orderInfo.enterCode }}</span>
          </li>
          <li>
