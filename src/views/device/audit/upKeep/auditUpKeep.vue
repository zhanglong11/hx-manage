    ...
    <div class="info">
      <div class="content">
        ...
        <ul>
          ...
          <li>
            <span class="label">保养责任人</span>
            <span class="val">{{ orderInfo.principalName }}</span>
          </li>
          <li>
            <span class="label">保养日期</span>
            <span class="val">{{ orderInfo.maintenanceTime }}</span>
          </li>
          <li>
            <span class="label">保养原因</span>
            <span class="val">{{ orderInfo.reason }}</span>
          </li>
          <li>
            <span class="label">设备保养单号</span>
            <span class="val">{{ orderInfo.maintenanceCode }}</span>
          </li>
          <li>
