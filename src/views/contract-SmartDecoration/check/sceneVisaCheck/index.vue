  ...
  <div class="contentWrapper">
    ...
    <div class="tableWrapper">
      <vxe-table ref="xTable" border :data="tableData" :edit-config="{ trigger: 'manual', mode: 'row' }">
        ...
        <vxe-table-column field="accessNumber" title="现场签证编号" width="200" />
        <vxe-table-column field="accessName" title="现场签证名称" width="200" />
        <vxe-table-column field="place" title="部位" min-width="150" />
        <vxe-table-column field="accessDate" title="日期" width="120" />
        ...
        <vxe-table-column field="creatorName" title="创建人" width="80" />
...
export default {
  ...
  methods: {
    ...
    handleCheck(id) {
      this.$router.push({ name: `SceneVisaCheckDetail`, params: { id: id, isCheck: true } })
    },
    handleDelete(id) {
