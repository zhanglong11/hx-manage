    ...
    <section style="margin-top: 10px;">
      <el-card>
        ...
        <el-form ref="form" :model="form" style="width: 500px;" :rules="rules" class="form" label-width="110px">
          ...
          <el-form-item label="复检时间" prop="recheckDate" style="width: 100%;">
            <el-date-picker v-model="form.recheckDate" value-format="yyyy-MM-dd 00:00:00" style="width: 100%;" />
          </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        recheckDate: [{ required: true, message: '必填' }]
      }
    }
  },
  created() {
  ...
  methods: {
    async refresh() {
      ...
      if (
        ...
        res.data.recheckResult.find(r => r.draftFlag === 0).checkPerson
      ) {
