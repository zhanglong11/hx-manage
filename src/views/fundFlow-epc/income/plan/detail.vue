      ...
      <el-card class="box-card" shadow="never">
        ...
        <div>
          ...
          >
            ...
            <vxe-table-column field="detailName" title="收入费用"></vxe-table-column>
            ...
            <vxe-table-column field="planTime" title="预计收入时间">
              <template v-slot="{ row }">
                {{ row.planTime | formatData }}
              </template>
            </vxe-table-column>
            <vxe-table-column field="planAmount" title="预计收入金额(元)">
              <template v-slot="{ row }">
