  ...
  <div class="contentWrapper">
    ...
    <div class="tableWrapper">
      <vxe-table ref="xTable" border :data="tableData" :edit-config="{ trigger: 'manual', mode: 'row' }">
        ...
        <vxe-table-column field="specialName" title="现场签证编号" />
        <vxe-table-column field="changeCode" title="成本测算编号">
        ...
        <vxe-table-column field="specialName" title="成本测算名称" />
...
export default {
  ...
  methods: {
    ...
    handleDetail(id) {
      this.$router.push({ path: `contractTargetCostBudgetCheck/${id}`, params: { isEdit: false, isCheck: false } })
      // this.$router.push({
      //   name: `ContractTargetCostBudgetCheckDetail`,
      //   query: { id: id, isEdit: false, isCheck: false }
      // })
    },
    handleCheck(id) {
      this.$router.push({ path: `contractTargetCostBudgetCheck/${id}`, params: { isEdit: false, isCheck: true } })
      // this.$router.push({
      //   name: `ContractTargetCostBudgetCheckDetail`,
      //   query: { id: id, isEdit: false, isCheck: true }
      // })
    },
