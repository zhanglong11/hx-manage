<template>
  <div class="contentWrapper">
          ...
          <div class="wrapper">
            ...
            <div class="rightBlock">
              <el-card shadow="never">
                ...
                <div class="topTable" style="margin: 10px 0;">
                  <vxe-table ref="xTable" border :data="tableData" auto-resize>
                    ...
                    <vxe-table-column field="number" title="合同数量" width="120" />
                    ...
                    <vxe-table-column title="操作" width="150px">
                      <template v-slot="{ row }">
                        <vxe-button @click="showDetail(row.id)">编辑</vxe-button>
                      </template>
                    </vxe-table-column>
                  </vxe-table>
              ...
              <el-card v-if="detailVisible" shadow="never" style="margin-top: 20px;">
                ...
                <div>
                  <BudgetTabList :showSelect="false" :showOperateBtn="true" :showChanged="true"></BudgetTabList>
                </div>
              </el-card>
            </div>
          </div>
    ...
    <div v-if="showFooter" class="footerButton">
