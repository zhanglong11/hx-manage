  ...
  >
    <div style="width: 400px; margin: 0 auto;">
      <el-form ref="form" :model="form" :rules="formRule">
        <el-form-item label="成本测算名称" label-width="120px" prop="name" style="margin-right: 20px;">
          <el-input v-model="form.name" placeholder="请输入成本测算名称" class="inputStyle"> </el-input>
        </el-form-item>
