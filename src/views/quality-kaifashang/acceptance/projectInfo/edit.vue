    ...
    <section class="edit-section">
      <el-form ref="form" :model="form" :rules="rules" class="form" label-width="110px">
        <el-form-item label="单位编号" prop="qualityTargetDecomposeId">
          <el-input v-model="form.qualityTargetDecomposeId" disabled class="inputStyle" />
        </el-form-item>
        ...
        <el-form-item label="资料类型" prop="materialType">
          <el-select v-model="form.materialType" class="inputStyle" @change="() => (isRefresh = false)">
        ...
        <el-form-item label="项目种类" prop="projectType">
          <el-select v-model="form.projectType" class="inputStyle" @change="() => (isRefresh = false)">
      ...
      this.$refs.form.validate(async valid => {
        if (valid) {
          let res = this.$route.params.id
            ? await Api.projectInfo.update({ ...this.form, ...{ detailList: this.detailList } })
            : await Api.projectInfo.add({ ...this.form, ...{ detailList: this.detailList } })
