<template>
  <div class="container no-padding is-footer">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <ul class="info-list">
            <li>
              <span>允许偏差</span>
              <span>{{ form.allowableDeviation }}</span>
            </li>
          </ul>
        </el-col>
        <el-col :span="12">
    ...
    <!-- 首次检查合格不合格inspectStatus 1--合格 2 不合格 -->
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <ul v-if="form.inspectStatus === 2" class="info-list">
              <li>
                <span>本次检查内容</span> <span>{{ form.currentInspectContent }}</span>
              </li>
              <li>
          ...
          <el-col :span="form.inspectStatus === 1 ? 24 : 12">
            <ul class="info-list" :class="{ is_qualified: form.inspectStatus === 1 }">
              ...
              <li>
                <span>检查日期</span><span>{{ form.createDate | ymd }}</span>
              </li>
              <li>
                <span>现场照片</span>
    ...
    <template v-if="$hasPower('QualityInspectRecordCommentPCDetail')">
      <AddComments :id="id" type="QualityInspectRecord" :canAdd="$hasPower('QualityInspectRecordCommentPCAdd')" />
    </template>
    <!-- 批注组件 start -->
