  ...
  <div class="container no-padding is-footer">
    <el-card class="box-card">
      ...
      <el-form ref="formRef" :model="formData" :rules="formRules" label-width="200px" class="form-con">
        ...
        <el-row :gutter="20">
          <el-col :md="12">
            <el-form-item label="材料类型">
              <el-select v-model="formData.type" disabled class="form-input" placeholder="请选择材料类型">
                <el-option :value="1" label="甲供"></el-option>
                <el-option :value="2" label="自购"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :md="12">
            <el-form-item label="预算量" prop="budgetNumber">
              <el-input-number v-model="formData.budgetNumber" :min="0" class="form-input" placeholder="请输入预算量" />
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  data() {
    return {
      ...
      formRules: {
        ...
        budgetNumber: [{ required: true, message: '请输入预算量', trigger: 'blur' }]
      },
      isLoading: false
    }
  },
  ...
  methods: {
    ...
    async getMaterialDetailInfo() {
      ...
      this.formData.type = datas.type || 1
    },
    // 保存并提交
    save() {
