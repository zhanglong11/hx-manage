<template>
  <div class="container no-padding is-footer">
    ...
    <div class="footer-btn">
      ...
      <el-button v-if="info.status === 1" size="lg" type="primary" @click="checkVisible = true">审核</el-button>
      <el-button v-if="info.status === 2" size="lg" type="primary" @click="handlePurchase">采购</el-button>
...
import ReceiveGoodsDialog from '@/views/suppliesEquipment/materialManage/procurement/lib/ReceiveGoodsDialog'
export default {
  ...
  methods: {
    ...
    handleCheck() {
      ...
      this.axios.material.post(`materialPurchase/audit`, { ...this.form, ...obj }).then(res => {
