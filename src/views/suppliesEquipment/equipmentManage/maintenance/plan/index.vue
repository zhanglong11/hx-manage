  ...
  <div>
    <div class="tooltips">
      <el-form ref="pageQuery" :model="filterForm" inline>
        ...
        <el-form-item>
          <el-button-group v-if="$hasPower('MaintenancePlanList')">
  ...
  methods: {
    ...
    toEdit(id) {
      _.isNil(id)
        ...
        : this.$router.push({ name: `MaintenancePlanEdit`, params: { id } })
    },
    toDetail(id) {
      this.$router.push({ name: `MaintenancePlanDetail`, params: { id } })
    },
