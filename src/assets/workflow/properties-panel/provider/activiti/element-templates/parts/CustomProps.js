...
var IO_BINDING_TYPES = [ACTIVITI_INPUT_PARAMETER_TYPE, ACTIVITI_OUTPUT_PARAMETER_TYPE]

var IN_OUT_BINDING_TYPES = [ACTIVITI_IN_TYPE, ACTIVITI_OUT_TYPE, ACTIVITI_IN_BUSINESS_KEY_TYPE]
...
function getPropertyValue(element, property) {
  ...
  var activitiProperties, activitiProperty
...
function setPropertyValue(element, property, value, bpmnFactory) {
  ...
  // activiti:property
  var activitiProperties, existingActivitiProperty, newActivitiProperty
  ...
  if (bindingType === ACTIVITI_PROPERTY_TYPE) {
    ...
    if (!activitiProperties) {
      ...
      if (scope) {
        updates.push(cmdHelper.updateBusinessObject(element, bo, { properties: activitiProperties }))
      } else {
        updates.push(cmdHelper.addElementsTolist(element, extensionElements, 'values', [activitiProperties]))
      }
    }
