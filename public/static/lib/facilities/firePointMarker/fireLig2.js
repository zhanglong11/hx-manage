...
let _Math = THREE.Math;
let Mesh = THRE.Mesh;
let NearestFilter = THREE.NearestFilter;
let NoToneMapping = THREE.NoToneMapping;
let OrthographicCamera = THRE.OrthographicCamera;
let PlaneBufferGeometry = THREE.PlaneBufferGeometry;
